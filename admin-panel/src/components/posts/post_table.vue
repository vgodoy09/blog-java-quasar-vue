    ...
    <table class="table table-striped table-light table-bordered table-hover text-center" id="dataTable" width="100%" cellspacing="0">
      <thead>
        <tr>
          ...
          <th>Published</th>
          <th v-if="typeof $route.params.user === 'undefined' || $route.params.user == null || $route.params.user == ''">
            <router-link to="/users">Author</router-link>
          </th>
          <th v-if="typeof $route.params.category === 'undefined' || $route.params.category == null || $route.params.category == ''">
